...
class AvailableTimesList extends StatelessWidget {
  ...
  AvailableTimesList(this._availableTimes,this._docKey);
  ...
  Widget ContainerList(index) {
    return GetBuilder<CreateDetailsAppointmentController>(
        init: Get.put(CreateDetailsAppointmentController(_docKey)),
